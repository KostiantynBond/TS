...
function testTriangle() {
  ...
  logTestCase(
    "Valid right triangle (hypotenuse and leg)",
    5,
    "hypotenuse",
    3,
    "leg",
  ...
  logTestCase(
    "Valid right triangle (angle and hypotenuse)",
    30,
    "angle",
    10,
    "hypotenuse",
  ...
  logTestCase(
    ...
    4,
    "leg",
    "Invalid input: Values must be positive numbers."
  );
  logTestCase(
    "Negative leg (second)",
    3,
